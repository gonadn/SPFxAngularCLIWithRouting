...
class Package {
    ...
    static createFromNpm(npmPackage) {
        ...
        const newPackage = new Package(npmPackage.package.name, npmPackage.package.version, dependencies, 
     ...
     */
    static createLinkedPackage(name, version, dependencies, folderPath) {
